...
<div class="register-box" style="margin-left:auto; margin-right:auto">
    ...
    <div class="card">
        <div class="card-body register-card-body">
            <p class="login-box-msg">Заполните форму</p>
            ...
            <form action="{{ route('login') }}" method="post">
                ...
                <div class="input-group mb-3">
                    <input type="email" name="email" class="form-control @error('title') is-invalid @enderror" placeholder="Email" value="{{ old('email') }}">
                ...
                <div class="row">
                    ...
                    <a class="btn btn-block" href="{{ route('register.create') }}">Регистрация</a>
                </div>
            </form>
        </div>
    </div>
