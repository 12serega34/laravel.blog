                    ...
                    <div class="col-12">
                        <div class="card">
                                        ...
                                        <table class="table table-bordered table-hover text-nowrap">
                                            ...
                                            @foreach($posts as $post)
                                                <tr>
                                                    ...
                                                    <td>{{ $post->tags->pluck('title')->join(', ') }}</td> {{--выводим все это в виде коллекций--}} {{--pluck('title') - выводит только тайтлы из коллекции. join(', ') - перечисляет все тайтлы через запятую--}}
                            ...
                            <div class="card-footer clearfix">
                                {{ $posts->links('vendor.pagination.bootstrap-4') }} {{--Это пагинация--}}
