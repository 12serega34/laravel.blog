...
class HomeController extends Controller
{
    ...
    public function show($slug)
    {
        ...
        $userName = DB::table('users')->where('id', $id)->value('name'); //Если не нужна вся строка, можете извлечь одно значение из записи с помощью метода value, который вернет значение столбца напрямую

        return view('posts.article', compact('post', 'randomPost', 'comments', 'userName'));
    }
